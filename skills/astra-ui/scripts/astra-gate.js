...
function extractGateContract(markdown) {
  ...
  if (!match) {
    throw new Error(
      'Missing ASTRA gate contract block in SKILL.md. Expected a JSON block between the gate markers.'
    );
  }
...
function renderSystemGuide(contract) {
  ...
  return [
    ...
    '> Source: `skills/astra-ui/SKILL.md` Gate Contract.',
    '',
    '## Usage',
    '',
