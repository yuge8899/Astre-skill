...
shadcn/ui 不包含图表，数据分析页面需要额外引入：

| 场景 | 推荐库 | 说明 |
|------|--------|------|
| 折线图、柱状图、饼图 | `recharts` | React 生态，shadcn 官方推荐 |
| 复杂图表、地图 | `echarts` / `@antv/g2` | 功能更全 |
| 简单数据展示 | 用 Table + Badge | 不需要图表库 |
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={comparisonData}>
              ...
              <YAxis stroke="#737373" fontSize={12} />
              <Tooltip />
              <Bar dataKey="current" fill="#2E62FF" radius={[4, 4, 0, 0]} />
